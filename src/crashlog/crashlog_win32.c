...
#define PRINTF_PTR "0x%016llX"
#else
#define PRINTF_PTR "0x%08llX"
#endif
...
void CrashLog_LogRegisters(char *buffer)
{
	...
	sprintf(buffer + strlen(buffer),
		...
		" RIP: %.16llX EFLAGS: %.8lX\n",
		(unsigned long long)s_ep->ContextRecord->Rax,
		(unsigned long long)s_ep->ContextRecord->Rbx,
		(unsigned long long)s_ep->ContextRecord->Rcx,
		(unsigned long long)s_ep->ContextRecord->Rdx,
		(unsigned long long)s_ep->ContextRecord->Rsi,
		(unsigned long long)s_ep->ContextRecord->Rdi,
		(unsigned long long)s_ep->ContextRecord->Rbp,
		(unsigned long long)s_ep->ContextRecord->Rsp,
		(unsigned long long)s_ep->ContextRecord->R8,
		(unsigned long long)s_ep->ContextRecord->R9,
		(unsigned long long)s_ep->ContextRecord->R10,
		(unsigned long long)s_ep->ContextRecord->R11,
		(unsigned long long)s_ep->ContextRecord->R12,
		(unsigned long long)s_ep->ContextRecord->R13,
		(unsigned long long)s_ep->ContextRecord->R14,
		(unsigned long long)s_ep->ContextRecord->R15,
		(unsigned long long)s_ep->ContextRecord->Rip,
